  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: "8.5pt", marginBottom: "10pt" }}>
        <strong>Note: 1.</strong> All the Co-Curricular (Including Curriculum
        gap), Extra Curricular activities for odd &amp; even Semester are to be
        planned at the commencement the academic year in line with Institution
